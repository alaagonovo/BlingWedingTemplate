export default [
  {
    title: "Step 1",
    subTitle: "Inspiring Vlogs",
    paragraphs: [
      "Follow our journey as we travel the world, capturing the most spectacular weddings and sharing behind-the-scenes footage, tips, and stories",
  ...
  {
    title: "Step 2",
    subTitle: "Featured Brides",
    paragraphs: [
      "Meet brides from around the globe and get inspired by their unique stories and stunning wedding celebrations.",
  ...
  {
    title: "Step 4",
    subTitle: "Bridal Wedding Coupons",
    paragraphs: [
      "Exclusive deals and discounts to help you save on everything from wedding dresses to venue rentals and beyond.",
